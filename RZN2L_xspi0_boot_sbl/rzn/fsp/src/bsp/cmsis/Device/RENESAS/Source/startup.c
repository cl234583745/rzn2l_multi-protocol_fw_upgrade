...
void SystemInit (void)
{
    ...
    src  = (uintptr_t *) &_mdata;
    dst  = (uintptr_t *) &_data_start;
    size = (uintptr_t) &_data_end - (uintptr_t) &_data_start;
...
/* Invalid MPU and cache settings for loader project.
 * MPU and cache settings are done in the application program.
