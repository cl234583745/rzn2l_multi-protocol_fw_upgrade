...
C_SRCS += \
../rzn/fsp/src/rm_freertos_port/cr/port.c 

LST += \
port.lst 

C_DEPS += \
./rzn/fsp/src/rm_freertos_port/cr/port.d 

OBJS += \
./rzn/fsp/src/rm_freertos_port/cr/port.o 
...
rzn/fsp/src/rm_freertos_port/cr/%.o: ../rzn/fsp/src/rm_freertos_port/cr/%.c
	@echo 'Building file: $<'
