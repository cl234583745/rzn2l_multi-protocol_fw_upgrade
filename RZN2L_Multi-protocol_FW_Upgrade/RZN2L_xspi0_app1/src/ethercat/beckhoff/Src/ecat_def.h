...
#if (ETHERCAT_FEATURE == CIA402_DRIVE) || (ETHERCAT_FEATURE == CONFORMANCE)
...
#define BACKUP_PARAMETER_SUPPORTED                1 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#else
...
#define STORE_BACKUP_PARAMETER_IMMEDIATELY        1 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#ifndef PRODUCT_CODE
#if (ETHERCAT_FEATURE == CONFORMANCE)
#define PRODUCT_CODE                              0x00000910
#elif (ETHERCAT_FEATURE == CIA402_DRIVE)
#define PRODUCT_CODE                              0x00000911
#elif (ETHERCAT_FEATURE == SEMI_DEVICE)
#define PRODUCT_CODE                              0x00000912
#endif
#endif
...
#define REVISION_NUMBER                           0x00000300
#endif
...
#if (ETHERCAT_FEATURE == SEMI_DEVICE)
#define DEVICE_PROFILE_TYPE                       0x0000138B
#else
...
#ifndef DEVICE_NAME
#define DEVICE_NAME                               "Renesas EtherCAT RZ/N2"
#endif
