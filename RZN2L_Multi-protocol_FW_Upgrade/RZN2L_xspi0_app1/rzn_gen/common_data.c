...
{ .p_ctrl = &g_timer0_ctrl, .p_cfg = &g_timer0_cfg, .p_api = &g_timer_on_cmt };
...
{ .eeprom_size = ETHERCAT_SSC_PORT_EEPROM_SIZE_UNDER_32KBIT, .txc0 = ETHERCAT_SSC_PORT_TXC_DELAY_00NS, .txc1 =
          ETHERCAT_SSC_PORT_TXC_DELAY_00NS,
  .txc2 = ETHERCAT_SSC_PORT_TXC_DELAY_00NS, .p_ether_phy_instance[0] =
...
{ .reset_hold_time = 1, .reset_wait_time = 15000, .address_offset = 0,
...
{ .p_ctrl = &g_ethercat_ssc_port0_ctrl, .p_cfg = &g_ethercat_ssc_port0_cfg, .p_api =
